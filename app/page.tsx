  ...
  return (
    <>
      ...
      <svg className="invisible -z-50 absolute w-0" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <symbol id="hamburger-icon" viewBox="0 0 24 11">
          <g fill="#2D314D" fillRule="evenodd">
            <path d="M0 0h24v1H0zM0 5h24v1H0zM0 10h24v1H0z" />
          </g>
        </symbol>
        <symbol id="close-icon" viewBox="0 0 18 19">
          <g fill="#2D314D" fillRule="evenodd">
        ...
        <symbol id="youtube-icon" viewBox="0 0 21 20">
          <path
            fill="#FFF"
        ...
        <symbol id="pinterest-icon" viewBox="0 0 20 20">
          <path
            fill="#FFF"
